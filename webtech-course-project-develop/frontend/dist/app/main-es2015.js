...
module.exports = __webpack_require__(/*! C:\Users\Lenovo\Desktop\PROJECT SEB\E-Business-Systems-Project-test\webtech-course-project-develop\frontend\src\main.ts */"zUnb");
...
class BasicAuthInterceptor {
    constructor() { }
    intercept(req, next) {
        const reqHeader = req.clone({ headers: req.headers.set('Authorization', _constants__WEBPACK_IMPORTED_MODULE_0__["TOKEN_LOCAL_STORAGE_KEY"]) });
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 12, vars: 9, consts: [[1, "form", 3, "formGroup", "ngSubmit"], ["appearance", "fill"], ["matInput", "", "type", "email", "placeholder", "Email", 3, "formControl"], [4, "ngIf"], ["matInput", "", "placeholder", "Name", 3, "formControl"], ["matInput", "", "type", "password", "placeholder", "Password", 3, "formControl"], ["mat-button", "", "type", "submit", 1, "submit-button", 3, "disabled", "click"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "form", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_10_listener() { return ctx.onFormSubmit(); });
...
/* harmony import */ var _basic_auth_interceptor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./basic-auth.interceptor */ "738X");
/* harmony import */ var _users_services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./users/services/auth.service */ "77R9");
...
/* harmony import */ var _users_register_register_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./users/register/register.component */ "MSZs");
/* harmony import */ var _users_login_login_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./users/login/login.component */ "6F30");
/* harmony import */ var _continue_order_modal_continue_order_modal_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./continue-order-modal/continue-order-modal.component */ "AYad");
/* harmony import */ var _workspaces_workspaces_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./workspaces/workspaces.component */ "P2QX");
/* harmony import */ var _header_bar_header_bar_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./header-bar/header-bar.component */ "GhOa");
/* harmony import */ var _profile_info_profile_info_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./profile-info/profile-info.component */ "F7zS");
/* harmony import */ var _departments_departments_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./departments/departments.component */ "sy50");
/* harmony import */ var _cart_dialog_cart_dialog_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./cart-dialog/cart-dialog.component */ "85G9");
/* harmony import */ var _templates_templates_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./templates/templates.component */ "BsGo");
...
AppModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_22__["ɵɵdefineNgModule"]({ type: AppModule, bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"]] });
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_22__["ɵɵdefineInjector"]({ providers: [_users_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
        {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_22__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"],
        _home_home_component__WEBPACK_IMPORTED_MODULE_12__["HomeComponent"],
        _users_register_register_component__WEBPACK_IMPORTED_MODULE_13__["RegisterComponent"],
        _users_login_login_component__WEBPACK_IMPORTED_MODULE_14__["LoginComponent"],
        _continue_order_modal_continue_order_modal_component__WEBPACK_IMPORTED_MODULE_15__["ContinueOrderModalComponent"],
        _header_bar_header_bar_component__WEBPACK_IMPORTED_MODULE_17__["HeaderBarComponent"],
        _workspaces_workspaces_component__WEBPACK_IMPORTED_MODULE_16__["WorkspacesComponent"],
        _departments_departments_component__WEBPACK_IMPORTED_MODULE_19__["DepartmentsComponent"],
        _templates_templates_component__WEBPACK_IMPORTED_MODULE_21__["TemplatesComponent"],
        _profile_info_profile_info_component__WEBPACK_IMPORTED_MODULE_18__["ProfileInfoComponent"],
        _cart_dialog_cart_dialog_component__WEBPACK_IMPORTED_MODULE_20__["CartDialogComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_10__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
...
class UserService {
    ...
    login(email, password) {
        const loginUserObservable = this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].serveUrl + '/user/login', { email, password });
        return loginUserObservable
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((user) => this.saveCurrentUser(user)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1));
    }
    register(name, email, password) {
        const registerUserObservable = this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].serveUrl + '/user', {
            name,
            email,
            password
        });
    ...
    isLoggedIn() {
        const expiration = localStorage.getItem(_constants__WEBPACK_IMPORTED_MODULE_3__["EXPIRES_AT_LOCAL_STORAGE_KEY"]);
        if (!expiration) {
            return false;
        }
        const expiresAt = moment__WEBPACK_IMPORTED_MODULE_2__(JSON.parse(expiration));
    ...
    saveCurrentUser(user) {
        const expiresAt = moment__WEBPACK_IMPORTED_MODULE_2__().add(user.expiresIn, 'second');
    ...
    setSession(authResult) {
        const expiresAt = moment__WEBPACK_IMPORTED_MODULE_2__().add(authResult.expiresIn, 'second');
